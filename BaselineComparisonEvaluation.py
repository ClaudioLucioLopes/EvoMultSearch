...
if __name__ == "__main__":
        ...
        for prompt_name, format_func in BASELINE_PROMPT_FORMATTERS.items():
            ...
            for i, example in enumerate(evaluation_sample):
                ...
                try:
                    ...
                    # if self.debug_print:
                    # print(f"  Ex {i+1}: Resp='{extracted_answer}', Correct='{correct_answer}',  InTok={in_tokens}, OutTok={out_tokens}")
                    print(model_id,prompt_name,extracted_answer,response,correct_answer)
    ...
    if baseline_results:
        ...
        base_filename = f"baseline_comparison_simple_{dataset_base}_{sampling_info}_{seed_info}_{timestamp}"
...
# python BaselineComparisonEvaluation.py \
